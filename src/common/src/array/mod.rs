...
use self::{
    ...
    scalar::{
        NullableFixedSizeListRef, NullableFixedSizeListRefMut, NullableFixedSizedList, Scalar,
        ScalarRef, ScalarRefMut,
    },
};
...
#[cfg(test)]
mod tests {
    use super::{scalar::Scalar, Array, FixedSizedListArray, IdArray, ListArray, PrimitiveArray};
    use crate::array::{scalar::NullableFixedSizedList, NullableFixedSizedListArray};
